...
import com.example.face2face.databinding.ActivityIncomingInvitationBinding;
                    ...
                    public void onResponse(@NonNull Call<String> call, @NonNull Response<String> response) {
                        if (response.isSuccessful()) {
                            if (type.equals(Constants.REMOTE_MSG_INVITATION_ACCEPTED)) {
                                ...
                                Toast.makeText(IncomingInvitationActivity.this, "Inviatation Rejected", Toast.LENGTH_SHORT).show();
                                finish();
                            }
                        } else {
